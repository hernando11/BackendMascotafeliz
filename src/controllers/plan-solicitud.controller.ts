...
export class PlanSolicitudController {
  ...
  async find(
    ...
    return this.planRepository.solicituds(id).find(filter);
  }
  ...
  async create(
    ...
    return this.planRepository.solicituds(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.planRepository.solicituds(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.planRepository.solicituds(id).delete(where);
  }
}
